 ...
 * @author Admin
 */
public class PopupPhieuTra extends javax.swing.JFrame {

    /**
     * Creates new form PopupPhieuNhapChiTiet
     */
    public PopupPhieuTra() throws SQLException, Exception {
        initComponents();
        setLocationRelativeTo(null);
        txtid.setText("ID: "+Integer.toString(new NhapKho().idState));
        txtcode.setText("Mã phiếu trả: "+new NhapKho().code);
    ...
    private void btnAddPhieuNhapActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddPhieuNhapActionPerformed
        ...
        try {
            ...
            Logger.getLogger(PopupPhieuTra.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new PopupPhieuTra().setVisible(true);
                } catch (SQLException ex) {
                    Logger.getLogger(PopupPhieuTra.class.getName()).log(Level.SEVERE, null, ex);
                } catch (Exception ex) {
                    Logger.getLogger(PopupPhieuTra.class.getName()).log(Level.SEVERE, null, ex);
